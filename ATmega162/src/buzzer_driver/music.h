...
const uint8_t PROGMEM duration[2][80] = {
	//Super Mario:
	 {12, 12, 12, 12,
	 12, 12, 12, 12,
	 12, 12, 12, 12,
	 ...
	 //Star wars, imperial march:
	 {
		 50, 50, 50, 35, 15, 50, 35, 15, 65, 
		 50,
		 50, 50, 50, 35, 15, 50, 35, 15, 65,
		 50,
		 50, 30, 15, 50, 32, 17, 12, 12, 25,
		 32,
		 25, 50, 32, 17, 12, 12, 25, 
		 35, 
		 25, 50, 35, 12, 50, 37, 12, 65, 
		 50,
		 50, 30, 15, 50, 32, 17, 12, 12, 25,
		 32,
		 25, 50, 32, 17, 12, 12, 25,
		 35,
		 25, 50, 37, 12, 50, 37, 12, 65,
		 65
	 }
};
